...
class CompanyCustomerActiveRule implements ValidationRule
{
    /**
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if ($customer->customer_type !== CustomerTypeEnum::COMPANY->value) {
            $fail(trans(ExceptionMessages::MSG_CUSTOMER_IS_NOT_COMPANY));
        }
    }
}
